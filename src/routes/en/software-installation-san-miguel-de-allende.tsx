          ...
          "@graph": [
            {
              ...
              name: "Software installation in San Miguel de Allende",
              serviceType: "Software installation and configuration for Windows and macOS",
              description,
              ...
              availableChannel: [
                {
                  "@type": "ServiceChannel",
                  serviceUrl: absoluteUrl("/en/request-diagnosis"),
